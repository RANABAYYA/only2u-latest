-- ============================================================================
-- Fix Foreign Key Constraints (v3 - Robust with Existence Checks)
-- ============================================================================
-- This script safely attempts to fix constraints only on tables that actually exist.
-- It avoids errors if a table (like order_support_tickets) is missing or is a View.
-- ============================================================================
...
-- 6. SUPPORT TICKETS (Try both names)
DO $$
BEGIN
    -- Check 'order_support_tickets'
